...
bool DeviceVK::init(const SwapchainInfo& swapChainInfo, Window* pWindow)
{
...
bool DeviceVK::initInstance(Window* pWindow, bool debugMode)
{
...
bool DeviceVK::initDebugLayerCallback()
{
    ...
    debugCallbackInfo.pfnUserCallback   = vulkanCallback;
...
bool DeviceVK::initSurface(Window* pWindow)
{
...
bool DeviceVK::pickPhysicalDevice()
{
...
bool DeviceVK::pickQueueFamilyIndices()
{
...
bool DeviceVK::initSwapchain(const Window* pWindow)
{
...
bool DeviceVK::initSwapchainImageViews()
{
...
bool DeviceVK::verifyRequiredExtensionsSupported(const std::vector<std::string>& extensionNames)
{
...
bool DeviceVK::verifyRequiredDeviceExtensionsSupported(VkPhysicalDevice physicalDevice)
{
...
bool DeviceVK::verifyLayerSupport()
{
...
bool DeviceVK::querySwapchainSupport(VkPhysicalDevice physicalDevice, SwapchainSupportDetails& supportDetails) const
{
    supportDetails = {};
...
void DeviceVK::chooseSwapchainFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats)
{
...
VkPresentModeKHR DeviceVK::chooseSwapchainPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) const
{
...
VkExtent2D DeviceVK::chooseSwapchainExtent(const VkSurfaceCapabilitiesKHR& capabilities, const Window* pWindow) const
{
